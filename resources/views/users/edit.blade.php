                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control{{ $errors->has('instructorNo') ? ' is-invalid' : '' }}" id="instructorNo" name="instructorNo" value="{{ old('instructorNo', $user->instructorNo) }}">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control{{ $errors->has('instructorInitials') ? ' is-invalid' : '' }}" id="instructorInitials" name="instructorInitials" value="{{ old('instructorInitials', $user->instructorInitials) }}">
